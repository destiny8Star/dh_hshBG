                    ...
                    <div class="main-inner">
                        <div class="form-list">
                            <el-form label-position="left" ref="form" :model="form" label-width="120px" :rules="rules">
                                ...
                                <el-form-item label="运费模板" prop="freight_expense_id">
                                ...
                                <el-card style="margin-bottom: 32px;" v-if="form.is_sku==0">
                                    <el-form-item label="规格目录" prop="sku_list">
                                        <p class="ly_hint_text ly_hint_text_color">（ 最多添加三个规格，且每个规格至少添加一个属性 ）</p>
                                    </el-form-item>
                                    <el-card class="box-card" style="margin-bottom: 32px;box-shadow: none;" v-for="(ele,i) in form.sku_list" :key="i">
                                        <div slot="header" class="clearfix ly-flex-center-between">
                                            <el-form-item :label="`规格${map[i]}`" style="margin-bottom: 0" :prop="`sku_list.${i}.skuName`" :rules="ele.sku_rules.skuName">
                                                <el-input v-model="ele.skuName" maxlength="12" placeholder="请输入规格名称"></el-input>
                                            </el-form-item>
                                            <el-button :disabled="i==0" size="mini" type="danger" @click="delSku(ele,i)">删除</el-button>
                                        </div>
                                        <div class="attr_box">
                                            <p style="margin-bottom: 6px">规格属性：</p>
                                            <p class="attr_item" v-for="(val,v) in ele.attrList" :key="v">{{val.attr_name}}
                                            ...
                                            <el-row class="ly-flex-center" style="margin-top: 10px">
                                                <el-form-item style="margin-bottom: 0" label="新增属性名称" :prop="`sku_list.${i}.attrText`" :rules="ele.sku_rules.attrText">
                                    ...
                                    <p style="margin-top: -12px"><el-button type="primary" size="mini" @click="addSku()" :disabled="form.sku_list.length==3">添加</el-button></p>
                                </el-card>
